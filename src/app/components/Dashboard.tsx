      ...
      <div className="max-w-[1800px] mx-auto p-4 md:p-6 lg:p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-1">
            <h1 className="text-3xl font-bold text-violet-950">{t.dashboard.title}</h1>
          ...
          <div className="col-span-12 lg:col-span-8 space-y-4 lg:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-white rounded-2xl p-5 border border-gray-100">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="px-2 py-1 bg-violet-500/10 rounded-md">
                    <span className="text-[10px] font-bold text-violet-950">+8%</span>
                  </div>
                </div>
                <div className="flex items-baseline gap-1 mb-1">
                  <h2 className="text-4xl font-bold text-violet-950">19,365</h2>
              ...
              <div className="bg-white rounded-2xl p-5 border border-gray-100">
                ...
                <div className="flex items-baseline gap-2 mb-1">
                  <h2 className="text-4xl font-bold text-violet-950">4.2</h2>
              ...
              <div className="bg-violet-500 rounded-2xl p-5">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="px-2 py-1 bg-violet-500/20 rounded-md">
                    <span className="text-[10px] font-bold text-violet-500">-2.7kg</span>
                  </div>
                </div>
                <div className="flex items-baseline gap-2 mb-1">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <div className="w-1.5 h-1.5 rounded-full bg-violet-500"></div>
                    <h3 className="text-sm font-bold text-violet-950">Analytics</h3>
                  </div>
                  <p className="text-xs text-gray-400">Omega-6:3 Ratio Evolution</p>
                </div>
                <div className="flex items-center gap-2">
                  <button className="px-3 py-1.5 bg-violet-500 text-white rounded-lg text-xs font-semibold">Tracker</button>
                  <button className="px-3 py-1.5 text-gray-400 hover:text-violet-950 rounded-lg text-xs font-semibold transition-colors">Medical</button>
                  <button className="px-3 py-1.5 text-gray-400 hover:text-violet-950 rounded-lg text-xs font-semibold transition-colors">Fitness</button>
                </div>
              </div>
              ...
              <div className="h-[240px]">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={omegaRatioData} barSize={24}>
                    ...
                    />
                    <Bar dataKey="ratio" fill="#1a1a1a" radius={[8, 8, 0, 0]} activeBar={{ fill: '#6366F1' }} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-100">
                <div>
                  ...
                  <p className="text-sm font-semibold text-violet-950">72%</p>
                </div>
                <div>
                  <p className="text-xs text-gray-400 mb-1">Improvement</p>
                  <p className="text-sm font-semibold text-violet-950">-72% ratio</p>
                </div>
                <div>
                  <p className="text-xs text-gray-400 mb-1">Days remaining</p>
                  <p className="text-sm font-semibold text-violet-950">73 days</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-xl font-bold text-violet-950 mb-6">TAKE A<br/>BREATH NOW</h3>
                  <div className="flex items-center gap-4 mb-6">
                    <div className="flex-1">
                      <div className="w-20 h-20 rounded-full bg-violet-500 flex items-center justify-center relative">
                        <span className="text-2xl font-bold text-violet-950">10.57</span>
                        <div className="absolute -right-2 -top-2 w-6 h-6 rounded-full bg-violet-500/30 flex items-center justify-center">
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-400">
                    ...
                    <span className="w-6 h-6 rounded-full bg-violet-500 text-white flex items-center justify-center font-semibold">W</span>
                ...
                <div className="flex items-center justify-center">
                  <div className="relative">
                    <svg width="200" height="200" viewBox="0 0 200 200">
                      ...
                      <circle cx="100" cy="100" r="80" fill="none" stroke="#6366F1" strokeWidth="12"
                        strokeDasharray={`${2 * Math.PI * 80 * 0.73} ${2 * Math.PI * 80}`}
                        transform="rotate(-90 100 100)"/>
                    </svg>
                    <div className="absolute inset-0 flex items-center justify-center flex-col">
                      <p className="text-xs text-gray-400">Oxygen</p>
                      <p className="text-4xl font-bold text-violet-950">97.5<span className="text-lg">%</span></p>
                      <p className="text-2xl font-bold text-violet-950 mt-2">89<span className="text-sm">bpm</span></p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="col-span-12 lg:col-span-4 space-y-4 lg:space-y-6">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-1.5 h-1.5 rounded-full bg-violet-500"></div>
                <h3 className="text-sm font-bold text-violet-950">Progress</h3>
              </div>
              <div className="mb-4 rounded-xl overflow-hidden bg-gray-100 h-32 flex items-center justify-center">
                <div className="text-center">
                  <Award className="w-12 h-12 text-gray-300 mx-auto mb-2" />
                  <p className="text-xs text-gray-400">Running</p>
                  <p className="text-2xl font-bold text-violet-950">139</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between text-xs">
                  <span className="text-gray-400">Running</span>
                  <span className="font-semibold text-violet-950">Biking</span>
            ...
            <button
              ...
              className="w-full bg-violet-500 rounded-2xl p-5 flex items-center gap-4 hover:brightness-95 transition-all text-left"
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-white/80">Log your health metrics for today</p>
              </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-1.5 h-1.5 rounded-full bg-violet-500"></div>
                <h3 className="text-sm font-bold text-violet-950">{t.dashboard.dailyGoals}</h3>
              </div>
              <div className="space-y-3">
                {dailyGoals.map((goal, index) => (
                  <div key={index} className="flex items-center justify-between py-2">
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex-1">
                        <p className="text-xs text-violet-950 font-medium">{goal.label}</p>
                        {goal.unit && (
                    ...
                    <div className="flex items-center gap-2">
                      {goal.progress === 100 ? (
                        ...
                        <span className="text-xs font-bold text-violet-950">{goal.progress}%</span>
                      )}
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-violet-500"></div>
                  <h3 className="text-sm font-bold text-violet-950">Workout</h3>
                </div>
                <div className="px-2 py-1 bg-violet-500 rounded-md">
              ...
              <div className="flex items-baseline gap-1">
                <span className="text-3xl font-bold text-violet-950">139</span>
            ...
            <div className="bg-violet-500 rounded-2xl p-5">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-sm font-bold text-white mb-1">ZENO AI</h3>
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-100">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-1.5 h-1.5 rounded-full bg-violet-500"></div>
                <h3 className="text-sm font-bold text-violet-950">{t.dashboard.recentScans}</h3>
              </div>
              <div className="space-y-3">
                  ...
                  <div key={index} className="flex items-center gap-3 py-2">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center text-xs font-bold ${
                      scan.verdict === 'GOOD'
                        ...
                        : 'bg-violet-950/5 text-violet-950'
                    }`}>
                      {scan.score}
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-medium text-violet-950 truncate">{scan.name}</p>
                    ...
                    <div className={`px-2 py-1 rounded-md ${
                      ...
                      <span className="text-[10px] font-bold text-violet-950">
              ...
              <button className="w-full mt-4 py-2 text-xs font-semibold text-gray-400 hover:text-violet-950 transition-colors">
                {t.common.viewAll} →
              </button>
            </div>
